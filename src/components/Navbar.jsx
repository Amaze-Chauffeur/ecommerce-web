...
import {
  ...
  MoreDropdown,
  SideNav,
} from "../components/TopNavDropdown";
import {
  LoginDropdownData,
  MoreDropdownData,
  SideNavData,
} from "../components/TopNavDropdownData";
  ...
  return (
    <>
        ...
        <Container>
          <div className="row">
            ...
            <div className="d-none d-lg-block col-lg-2 more-btn">
              <li className="dropdown">
                <a className="links text-white">More</a>
                <div>
                  <List className="dropdown-menu">
            ...
            <div className="col-lg-1 cart-btn order-xs-2">
              <ShoppingCartIcon />
              <small className="d-none d-lg-block">Cart</small>
            </div>
          </div>
        </Container>
      </div>
      ...
      <div id="mySidenav" className="d-lg-none sidenav">
        <div
          className="container"
          style={{ backgroundColor: "#064420", color: "white", padding: 10 }}
        >
          <span className="sidenav-heading" style={{ fontSIze: 14 }}>
